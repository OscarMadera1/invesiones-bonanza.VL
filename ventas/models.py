...
class Venta(models.Model):
    ...
    municipio = models.ForeignKey('inventario.municipio', on_delete=models.PROTECT)
    total = models.DecimalField(max_digits=12, decimal_places=2, default=0.0, blank=True, null=True)
    zona = models.ForeignKey('zonas.Zona', on_delete=models.PROTECT)
